...
class ModalUser extends Component {
  ...
  render() {
    let { isOpenAddUser, handleCloseModal, language } = this.props;
    let {
      genderArr,
      positionArr,
      rolesArr,
    ...
    return (
      <>
        <Modal isOpen={isOpenAddUser} size="xl" >
          ...
          <ModalBody >
            <div className="container">
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <div className="preview-img-container">
                    ...
                    >
                       <img alt="" style={{width:'100%',height:'100%',objectFit:'cover'}} src={this.state.previewImgUrl} />
                    </div>
              ...
              {this.state.isOpen === true && (
                  <Lightbox className="preview-img" style={
                   {
                    '& .ReactModal__Overlay': {
                      display:"none"
                    }
